...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    {
        let success = server.startServer()
    }
    ...
    var applicationFilesDirectory: NSURL {
        // Returns the directory the application uses to store the Core Data store file. This code uses a directory named "com.picciano.SwiftServeDemo" in the user's Application Support directory.
        let fileManager = NSFileManager.defaultManager()
        let urls = fileManager.URLsForDirectory(.ApplicationSupportDirectory, inDomains: .UserDomainMask)
        let appSupportURL: AnyObject = urls[urls.endIndex - 1]
        return appSupportURL.URLByAppendingPathComponent("com.picciano.SwiftServeDemo")
    }
    ...
    var managedObjectModel: NSManagedObjectModel {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("SwiftServeDemo", withExtension: "momd")
    ...
    var persistentStoreCoordinator: NSPersistentStoreCoordinator? {
        ...
        let url = applicationFilesDirectory.URLByAppendingPathComponent("SwiftServeDemo.storedata")
